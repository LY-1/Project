...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights_path", type=str, default="checkpoints_tiny_512_part_GF_0325/yolov3_ckpt_478.pth", help="path to weights file")
    ...
    endtime_0 = time.time()
    #initialize path
    predictpath = root_path + '/result/conf_' + str(opt.conf_thres) + '/predict/'
    predictpath2 = root_path + '/result/conf_' + str(opt.conf_thres) + '/predict2/'
    ...
    rectpath = root_path + '/result/conf_' + str(opt.conf_thres) + '/rect/'
